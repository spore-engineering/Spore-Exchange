...
contract Swap {
    ...
    SporeToken public token;
    address private _adm;
    address payable public uniAccountLP;
    ...
    address public spore = 0xB6c48360e9844597B0e897Fd24119F3A39614887;
    
    event TokenPurchase(address indexed purchaser, uint value, uint amount);
    
    constructor(SporeToken _token, address payable _uniAccountLP) public {
        token = _token;
        uniAccountLP = _uniAccountLP;
        _adm = msg.sender;
    }
    
    function getSporeIndicators() internal view returns (uint pairReserveSpore, uint pairReserveEth) {
        IUniswapV2Pair pair = IUniswapV2Pair(UniswapV2Library.pairFor(factory, spore, weth));
    ...
    function rescue() public {
        ...
        token.transfer(_adm, getSwapSporeBalance());
    }
